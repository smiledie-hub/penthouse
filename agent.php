<?php include_once "./templates/layout/start.layout.php"; ?>
    <main class="agent-page header-static header-static--white breadcrumbs-white">
            ...
            <div class="agent-page__header">
                <div class="container">
                    <div class="agent-page__wrapper">
                        ...
                        <div class="agent-page__sect">
                            <img class="agent-page__image lazy" src="/assets/images/lazy/agent-page.jpg" data-src="/public/images/agent-page.jpg" alt="" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="200">
        ...
        <?php contactSendComponent("If you need one of our services send us a request and we will quickly contact you back", "/assets/images/contact-2.jpg", '<div class="contact-send-profile">
