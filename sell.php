        ...
        <div class="sell-scroll__sticky">
            <div class="sell-scroll__wrapper">
                ...
                <div class="sell-scroll__main">
                    <div class="sell-scroll-item sell-scroll-item--1" data-counter="white" data-title="black" data-next="black">
                    ...
                    <div class="sell-scroll-item sell-scroll-item--2" data-counter="white" data-title="white" data-next="white">
                ...
                possible!", "/public/images/contact-bg.jpg"); ?>
                    ...
                    <div class="sell-scroll-item sell-scroll-item--3" data-counter="black" data-title="black" data-next="black">
                        <div class="sell-scroll-item__wrapper-img-2">
                            <div class="sell-scroll-item__content">
                                <p class="sell-scroll-item__number">02.</p>
                                <p class="sell-scroll-item__text sell-scroll-item__text--2">We estimate your project and prepare a contract.</p>
                            </div>
                            <img class="sell-scroll-item__image-2" src="/public/images/scroll-2.jpg" alt="">
                        </div>
                    </div>
                    <div class="sell-scroll-item sell-scroll-item--4" data-counter="white" data-title="white" data-next="white">
                        ...
                        <div class="sell-scroll-item__inner">
                            ...
                            <p class="sell-scroll-item__text sell-scroll-item__text--3">We come to your property to take high-quality photos and videos.</p>
                        </div>
                    </div>
                    <div class="sell-scroll-item sell-scroll-item--5" data-counter="none" data-title="black" data-next="black">
                        <div class="sell-scroll-item__wrapper-img">
                            <div class="sell-scroll-item__content">
                                <p class="sell-scroll-item__number">04.</p>
                                <p class="sell-scroll-item__text sell-scroll-item__text--4">We release your property on our catalog and start to sell it.</p>
                            </div>
                ...
                <div class="sell-scroll__footer">
                    ...
                    <p class="sell-scroll__counter"><span class="sell-scroll__current">01</span> / <span class="sell-scroll__lenght">04</span></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="sell-advantages">
        ...
        <div class="sell-advantages__row-images row-images row-images--items-end row-images--right mb-100">
            <div class="row-images__item sell-advantages__item">
                ...
                <img class="sell-advantages__img row-images__img row-images__img--h710" src="/public/images/sell-1.jpg" alt="">
            </div>
            <div class="row-images__item">
                <img class="sell-advantages__img row-images__img row-images__img--h1080" src="/public/images/sell-2.jpg" alt="">
            </div>
        </div>
