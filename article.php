...
<?php HeaderComponent("header--dark"); ?>
    ...
    <main class="article header-static">
        ...
        <div class="article__header">
            <div class="container">
                <p class="article__time" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="200">
                    <time datetime="03.05.22">03.05.22</time>
                </p>
                <h1 data-aos="fade-right" data-aos-duration="1000" data-aos-delay="400">Why choose Dubai?</h1>
            </div>
        </div>
        ...
        <div class="article-content">
                ...
                <div class="box-image box-image--right">
                    <div class="box-image__content box-image__content--p-none">
                        <img data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200"
                             class="box-image__image box-image__image--mw-none mb-100"
            ...
            <div class="article-content__section">
                <div class="row-images row-images--items-end row-images--right mb-100">
                    <div class="row-images__item">
                        <img data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200"
                             class="row-images__img row-images__img--h710" src="/public/images/page-article-1.jpg"
                             alt="">
                    </div>
                    <div class="row-images__item">
                        <img data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400"
                             class="row-images__img row-images__img--h1080" src="/public/images/page-article-2.jpg"
                             alt="">
                    </div>
                </div>
                ...
                <div class="row-images row-images--items-end row-images--right row-images--text">
                    ...
                    <div class="row-images__item">
                        <p class="article-content__text-2" data-aos="fade-right" data-aos-duration="1000"
                           data-aos-delay="200">Where the sea greets you every morning, and pristine white sand welcomes
                            you home—on an island with a statement address in Dubai. Awaken your senses with every
                            breath, as you redefine your premium lifestyle, overlooking the majestic Arabian Sea at
                            Emaar Beachfront. </p>
                    </div>
                </div>
            </div>
            ...
            <div class="article-content__section">
                <div class="row-images row-images--items-end row-images--left row-images--960-710">
                    <div class="row-images__item">
                        <img data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200"
                             class="row-images__img row-images__img--h1080" src="/public/images/page-article-4.jpg"
                             alt="">
                    </div>
                    <div class="row-images__item">
                        <img data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400"
                             class="row-images__img row-images__img--h710" src="/public/images/page-article-5.jpg"
                             alt="">
                    </div>
                </div>
            </div>
        ...
        <div class="blog article__another">
            <div class="container">
                <div class="blog__another">
                    <p data-aos="fade-right" data-aos-duration="1000" data-aos-delay="200">Another articles</p>
                    <a data-aos="fade-right" data-aos-duration="1000" data-aos-delay="400" href="/"
                       class="btn btn--primary blog__back">Back to blog</a>
                </div>

                <div class="blog__headers blog__headers--line-gray">
                    <p class="blog__header"  data-aos="fade-right" data-aos-duration="1000" data-aos-delay="400">Article</p>
                    <p class="blog__header"  data-aos="fade-right" data-aos-duration="1000" data-aos-delay="600">Date</p>
                </div>
