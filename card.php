    ...
    <main class="card-page header-static">
                    ...
                    <div class="swiper card-banner__swiper">
                        <div class="swiper-wrapper card-banner__wrapper">
                            <div class="card-banner__slide swiper-slide">
                                <img class="card-banner__image lazy" src="/assets/images/lazy/card-image.jpg" data-src="/public/images/card-image.jpg" alt="">
                            </div>
                            <div class="card-banner__slide swiper-slide">
                                <img class="card-banner__image lazy" src="/assets/images/lazy/card-image.jpg" data-src="/public/images/card-image.jpg" alt="">
                            </div>
                    ...
                    <div class="card-detail__wrapper">
                        ...
                        <div class="card-detail__section">
                            <div class="card-detail-profile" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="1000">
                                <img class="card-detail-profile__image lazy" src="/assets/images/lazy/card-profile.jpg" data-src="/public/images/card-profile.jpg"
                                     alt="profile">
                                <div>
        ...
        <div class="card-description">
            ...
            <div class="card-description__wrapper card-description__wrapper--end">
                <img class="card-description__image lazy" src="/assets/images/lazy/card-description.jpg" data-src="/public/images/card-description.jpg" alt="card-description" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="0">
                        ...
                        <div class="swiper slider-schema" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
                            <div class="swiper-wrapper slider-schema__wrapper">
                                <div class="swiper-slide slider-schema__slide">
                                    <img class="slider-schema__image lazy" src="/assets/images/lazy/schema.jpg" data-src="/public/images/schema.jpg" alt="">
                                </div>
                                <div class="swiper-slide slider-schema__slide">
                                    <img class="slider-schema__image lazy" src="/assets/images/lazy/scroll-3.jpg" data-src="/public/images/scroll-3.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="card-infrastructure">
            ...
            <div class="card-infrastructure__wrapper">
                <div class="card-infrastructure__image">
                    <img class="lazy" src="/assets/images/lazy/infrastructure-1.jpg" data-src="/public/images/infrastructure-1.jpg" alt="infrastructure" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200"/>
                </div>
            ...
            <div class="card-infrastructure__background">
                <div class="card-infrastructure__wrapper-2">
                    ...
                    <img data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400" class="card-infrastructure__image-2 lazy" src="/assets/images/lazy/infrastructure-2.jpg" data-src="/public/images/infrastructure-2.jpg"
                         alt="infrastructure">
                </div>

                <div class="box-image box-image--right card-infrastructure__image-3">
                    <div class="box-image__content box-image__content--p250">
                        <img data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200" class="box-image__image lazy" src="/assets/images/lazy/infrastructure-3.jpg" data-src="/public/images/infrastructure-3.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
        <div class="card-lifestyle">
            ...
            <div class="box-image box-image--left card-lifestyle__image-1">
                <div class="box-image__content box-image__content--p250">
                    <img data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200" class="box-image__image lazy" src="/assets/images/lazy/lifestyle-1.jpg" data-src="/public/images/lifestyle-1.jpg" alt="">
                </div>
            </div>
            ...
            <div class="card-lifestyle__images row-images row-images--g50 row-images--right row-images--670-960">
                <div class="row-images__item">
                    <img class="row-images__img row-images__img--h670 lazy" src="/assets/images/lazy/lifestyle-2.jpg" data-src="/public/images/lifestyle-2.jpg" alt="" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                </div>
                <div class="row-images__item">
                    <img class="row-images__img row-images__img--h850 lazy" src="/assets/images/lifestyle-3.jpg" data-src="/public/images/lifestyle-3.jpg" alt="" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                </div>
            </div>
        ...
        <?php contactSendComponent("Send us your request and we will contact you as soon as
                possible!", "/assets/images/contact-bg.jpg", '<div class="contact-send-profile">
                        ...
                        <div class="front-residence front-residence--slide">
                            <div class="front-residence__inner">
                                ...
                                <div class="front-residence__image-box">
                                    <img class="front-residence__image lazy" src="/assets/images/lazy/front-residence.jpg" data-src="/public/images/front-residence.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
