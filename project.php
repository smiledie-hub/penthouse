    ...
    <main class="dubai-marina-page">
        ...
        <div class="dubai-marina-banner">
            ...
            <div class="dubai-marina-banner__content">
                <h1 class="dubai-marina-banner__title">Projects</h1>
            </div>
        </div>
        ...
        <div class="dubai-marina-about">
            <div class="container">
                <div class="dubai-marina-about__content">
                    ...
                    <p class="dubai-marina-about__desc">With an area of 50 million sq. ft., Dubai Marina is one of the
            ...
            <div class="dubai-marina-about__images row-images row-images--items-end row-images--right">
                <div class="row-images__item">
                    <p class="dubai-marina-about__text">One of the community’s key features is a water canal with a
                    ...
                    <img class="row-images__img row-images__img--h710" src="/public/images/dubai-marina-1.jpg"
                         alt="">
                </div>
                <div class="row-images__item">
                    <img class="row-images__img row-images__img--h1080" src="/public/images/dubai-marina-2.jpg"
                         alt="">
                </div>
            </div>
            ...
            <div class="dubai-marina-about__sect bg-second">
                <div class="dubai-marina-about__wrapper row-images row-images--right">
                    <div class="row-images__item">
                        <div class="dubai-marina-about__text-box">
                    ...
                    <div class="row-images__item">
                        <div class="dubai-marina-about__text-box2">
        ...
        <div class="dubai-marina-image box-image box-image--left">
            <div class="box-image__content">
                <img class="about-page-desc__image box-image__image"
                     src="/public/images/dubai-marina-slider-1.jpg" alt="">
            </div>
        </div>
        ...
        <div class="dubai-marina-location">
            <div class="container">
                <div class="dubai-marina-location__content">
                    <h2 class="dubai-marina-location__title">
                        <span class="dubai-marina-location__start">Location</span>
                        <span class="dubai-marina-location__sg fn-sg">&</span>
                        <span class="dubai-marina-location__end">Infrastructure</span>
                    </h2>

                    <p class="dubai-marina-location__text">Dubai Marina is conveniently located along Sheikh Zayed Road,
            ...
            <div class="row-images row-images--items-end row-images--left row-images--960-710">
                <div class="row-images__item">
                    <img class="row-images__img row-images__img--h1080"
                         src="/public/images/project-1.jpg"
                         alt="">
                </div>
                <div class="row-images__item">
                    <img class="row-images__img row-images__img--h710"
                ...
                <div class="dubai-marina-location-block__image-box">
                    <div class="dubai-marina-location-block__wrapper">
                        ...
                        <div class="dubai-marina-location-block__image">
                            <img src="/public/images/dubai-marina-location-3.jpg"
                                 alt="">
                        </div>
                    </div>
                </div>
            ...
            <div class="dubai-marina-economic">
                <div class="container">
                    <div class="dubai-marina-economic__content">
                        <h2 class="dubai-marina-economic__title"><span
                                    ...
                                    class="dubai-marina-economic__end">Appeal</span></h2>
                        <p class="dubai-marina-economic__text dubai-marina-economic__text--1">As of Q3 2022, the entire
                ...
                <div class="dubai-marina-economic__box">
                    <div class="dubai-marina-economic__box-image box-image box-image--left">
                        <div class="box-image__content">
                            <img class="box-image__image" src="/public/images/dubai-marina-economic-1.jpg" alt="">
                        </div>
                    </div>

                    <div class="container">
                        <div class="dubai-marina-economic__box-text">
                            <p class="dubai-marina-economic__text dubai-marina-economic__text--2">According to Bayut and
                            ...
                            <p class="dubai-marina-economic__text dubai-marina-economic__text--3">Also, in line with the
        ...
        <div class="dubai-marina-promo">
            <div class="container">
                <p class="dubai-marina-promo__desc">Dubai Marina offers an abundance of exclusive leisure facilities,
            ...
            <div class="dubai-marina-promo__image-box">
                <div class="dubai-marina-promo__image">
                    <img src="/public/images/project-2.jpg" alt="">
                </div>
        ...
        <div class="dubai-marina-popular">
            <div class="container">
                <h2 class="dubai-marina-popular__title"><span class="dubai-marina-popular__start">Popular</span> <span
            ...
            <div class="dubai-marina-popular-block dubai-marina-popular-block--1">
                ...
                <div class="dubai-marina-popular-block__image dubai-marina-popular-block__image--right">
                    <img class="dubai-marina-popular-block__img-1" src="/public/images/project-3.jpg"
                         alt="">
                </div>
            </div>
            <div class="dubai-marina-popular-block dubai-marina-popular-block--2">
                ...
                <div class="dubai-marina-popular-block__image dubai-marina-popular-block__image--left">
                    <img class="dubai-marina-popular-block__img-1" src="/public/images/project-4.jpg"
                         alt="">
                </div>
            </div>
            <div class="dubai-marina-popular-block dubai-marina-popular-block--3">
                ...
                <div class="dubai-marina-popular-block__image dubai-marina-popular-block__image--right">
                    <img class="dubai-marina-popular-block__img-1" src="/public/images/project-5.jpg"
                         alt="">
                </div>
            </div>
        </div>
