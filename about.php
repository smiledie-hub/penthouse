    ...
    <main class="about-page">
        ...
        <div class="about-page-desc">
            <div class="about-page-desc__box-image box-image box-image--right">
                <div class="about-page-desc__content box-image__content">
                    <p class="about-page__text about-page-desc__text">Penthouse.ae powered by Metropolitan is one of the
            ...
            <div class="bg-second about-page-desc__sect">
                <div class="container">
                    <p class="about-page__text about-page-desc__text2">We are distinguished by a strong partnership with
                ...
                <div class="about-page-block image-content image-content--type-1">
                    <div class="image-content__content">
                        <p class="about-page-block__text">During the extensive work in Dubai's property market, the
                            company
                    ...
                    <div class="image-content__image-box">
                        <img class="image-content__image" src="/public/images/projects-1.jpg" alt="">
                    </div>
                </div>
        ...
        <div class="about-page__bg">
            <div class="about-company">
                <div class="container">
                    <h2 class="about-company__title"><span class="about-company__start">Facts about</span> <span
                                class="about-company__sg fn-sg">Our</span> <span
                                class="about-company__end">company:</span></h2>
                </div>

                <div class="swiper about-company__slider">
                ...
                <div class="about-company__image-content image-content image-content--type-2 image-content--image-right">
                    <div class="image-content__content">
                        <p class="about-page-block__text">We know exactly what people who appreciate luxury life are
                    ...
                    <div class="image-content__image-box">
                        <img class="image-content__image" src="/public/images/about-company-1.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="about-text-block">
            <div class="container">
                <p class="about-text-block__text">Best professionals of Penthouse.ae powered by Metropolitan clearly
            ...
            <div class="bg-second">
                ...
                <p class="about-text-block__desc">Guaranteed transparency of all transactions as well as power of our
        ...
        <div class="about-specialists">
            <div class="container">
                <h2 class="about-specialists__title">
                    <span class="about-specialists__sg fn-sg">Our</span>
                    <span class="about-specialists__end">specialists</span>
                </h2>

                <div class="about-specialists__items">
