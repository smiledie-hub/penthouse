...
<?php HeaderComponent("header--absolute"); ?>
    ...
    <main class="page-404 fullpage">
        <img class="fullpage__backgrond lazy" src="/assets/images/lazy/404.jpg" data-src="/public/images/404.jpg" alt="">
        ...
        <div class="container page-404__container">
            <div class="page-404__content">
                ...
                <div class="page-404__title">
                    ...
                    <img class="page-404__image lazy" src="/assets/images/lazy/404-2.jpg" data-src="/public/images/404-2.jpg" alt="404">
                    <span class="page-404__num">4</span>
                </div>
